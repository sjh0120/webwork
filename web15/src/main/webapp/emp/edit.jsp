			...
			<div class="col-md-12">
				...
				<form method="post">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="ename" name="ename" value="<%=bean.getEname() %>" placeholder="ename">
				  </div>
				  <div class="form-group">
				    <label for="sal">sal</label>
				    <input type="text" class="form-control" id="sal" name="sal" value="<%=bean.getSal() %>" placeholder="sal">
				  </div>
				  <div class="form-group">
				    <label for="hiredate">hiredate</label>
				    <input type="datetime" class="form-control" id="hiredate" name="hiredate" value="<%=bean.getHiredate() %>" placeholder="hiredate">
				  </div>
				  <div class="form-group">
				    <label for="job">job</label>
				    <input type="text" class="form-control" id="job" name="job" value="<%=bean.getJob() %>" placeholder="job">
				  </div>
