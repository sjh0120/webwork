...
<body>
	...
	<table width=600 align="center" border=1>
		...
		<tr>
			...
			<td align="center"><a href="revise.jsp?s_Num=<%=rs.getInt(1) %>"> <%=rs.getString(2)%></a></td>
	...
	<form action="TreqCh.jsp">
	<table>
	<tr>
	<td><input type="submit" value="요청 확인"> </td>
	</tr>
	</table>
	</form>
</body>
